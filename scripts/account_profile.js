        ...
        if (user) {
            ...
            currentUser.get()
                .then(userDoc => {
                    ...
                    // get which radio button is checked for department
                    ...
                    // get which radio button is checked for gender
                    ...
                    // get which radio button is checked for user type
...
function saveUserInfo() {
    console.log("inside")
    //enter code here to save the user info to the database
